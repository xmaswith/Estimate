...
public class FoodActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        priceAdapter = new PriceAdapter(FoodActivity.this, mInputModels, saveId, adapterName, new TextChanged() {
            @Override
        ...
        add_ib.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (addCount < 8){
                    Toast.makeText(FoodActivity.this, "add!", Toast.LENGTH_SHORT).show();
                    addCount++;
                    mInputModels.add(inputModel);
                    priceAdapter.notifyDataSetChanged();
                }
                else {
                    Toast.makeText(FoodActivity.this, "최대 8개까지만 입력 가능합니다!", Toast.LENGTH_SHORT).show();
                }
            }
        });
