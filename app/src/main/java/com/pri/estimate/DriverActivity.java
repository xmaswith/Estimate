...
public class DriverActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        priceAdapter = new PriceAdapter(DriverActivity.this, mInputModels, saveId, adapterName, new TextChanged() {
            @Override
        ...
        add_ib.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (addCount < 8){
                    Toast.makeText(DriverActivity.this, "add!", Toast.LENGTH_SHORT).show();
                    addCount++;
                    mInputModels.add(inputModel);
                    priceAdapter.notifyDataSetChanged();
                }
                else {
                    Toast.makeText(DriverActivity.this, "최대 8개까지만 입력 가능합니다!", Toast.LENGTH_SHORT).show();
                }
            }
        });
