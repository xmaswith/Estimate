...
public class HotelActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        priceAdapter = new PriceAdapter(HotelActivity.this, mInputModels, saveId, adapterName, new TextChanged() {
            @Override
            public void onChanged(int result, int position, String priceV, String countV) {
                ...
                total.setText(HotelActivity.this.getString(R.string.total)+" : " + mTotalDecimal);
            }
        });
        ...
        add_ib.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (addCount < 8){
                    ...
                    Toast.makeText(HotelActivity.this, HotelActivity.this.getString(R.string.estimateLimit_tst), Toast.LENGTH_SHORT).show();
                }
            }
        });
